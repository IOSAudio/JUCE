...
public:
    ...
    bool isBusesLayoutSupported (const BusesLayout& layouts) const override
    {
        ...
        if(mainOutput != AudioChannelSet::create5point1() && mainOutput != AudioChannelSet::stereo())
          return false;
...
private:
    ...
    {
//        return BusesProperties().withInput  ("Input",  AudioChannelSet::create7point1SDDS(), true)
//                                .withOutput ("Output", AudioChannelSet::create7point1SDDS(), true);
