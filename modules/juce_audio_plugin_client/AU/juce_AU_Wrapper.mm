      ...
      const int requestedNumBus = static_cast<int> (count);
      {
        ...
        for (busNr = (busCount - 1); busNr != (requestedNumBus - 1); busNr += (requestedNumBus > busCount ? 1 : -1))
        {
          if (requestedNumBus > busCount)
          {
            ...
            err = syncAudioUnitWithChannelSet (isInput, busNr + 1, juceFilter->getBus (isInput, busNr + 1)->getDefaultLayout());
...
public:
    ...
    static OSStatus ComponentEntryDispatch (ComponentParameters* params, JuceAU* effect)
    {
      DBG("*** JuceAU ComponentEntryDispatch");
    ...
    OSStatus SetBusCount (AudioUnitScope scope, UInt32 count) override
    {
      DBG("*** JuceAU SetBusCount " + String(count));
    ...
    UInt32 SupportedNumChannels (const AUChannelInfo** outInfo) override
    {
      DBG("*** JuceAU SupportedNumChannels");
    ...
    UInt32 GetAudioChannelLayout (AudioUnitScope scope, AudioUnitElement element,
                                  AudioChannelLayout* outLayoutPtr, Boolean& outWritable) override
    {
      DBG("*** JuceAU GetAudioChannelLayout");
    ...
    UInt32 GetChannelLayoutTags (AudioUnitScope scope, AudioUnitElement element, AudioChannelLayoutTag* outLayoutTags) override
    {
      DBG("*** JuceAU GetChannelLayoutTags");
    ...
    OSStatus SetAudioChannelLayout (AudioUnitScope scope, AudioUnitElement element, const AudioChannelLayout* inLayout) override
    {
      DBG("*** JuceAU SetAudioChannelLayout");
    ...
    float getMaximumParameterValue (AudioProcessorParameter* juceParam)
    {
      DBG("*** JuceAU getMaximumParameterValue");
...
//                      && outParameterInfo.defaultValue <= outParameterInfo.maxValue);
    ...
    ComponentResult GetParameterValueStrings (AudioUnitScope inScope,
                                              ...
                                              CFArrayRef *outStrings) override
    {
      DBG("*** JuceAU GetParameterValueStrings");
    ...
    // No idea what this method actually does or what it should return. Current Apple docs say nothing about it.
    // (Note that this isn't marked 'override' in case older versions of the SDK don't include it)
  bool CanScheduleParameters() const override          { DBG("*** JuceAU CanScheduleParameters"); return false; }

    //==============================================================================
    ComponentResult Version() override                   { DBG("*** JuceAU Version"); return JucePlugin_VersionCode; }
    bool SupportsTail() override                         { DBG("*** JuceAU SupportsTail"); return true; }
    Float64 GetTailTime() override                       { DBG("*** JuceAU GetTailTime"); return juceFilter->getTailLengthSeconds(); }
    double getSampleRate()                               { DBG("*** JuceAU getSampleRate "); return AudioUnitHelpers::getBusCount (juceFilter.get(), false) > 0 ? GetOutput (0)->GetStreamFormat().mSampleRate : 44100.0; }

    Float64 GetLatency() override
    {
        DBG("*** JuceAU GetLatency");
        const double rate = getSampleRate();
        jassert (rate > 0);
        return rate > 0 ? juceFilter->getLatencySamples() / rate : 0;
    }
    ...
    int GetNumCustomUIComponents() override
    {
        DBG("*** JuceAU GetNumCustomUIComponents");
        return getHostType().isDigitalPerformer() ? 0 : 1;
    }

    void GetUIComponentDescs (ComponentDescription* inDescArray) override
    {
        DBG("*** JuceAU GetUIComponentDescs");
        inDescArray[0].componentType = kAudioUnitCarbonViewComponentType;
        inDescArray[0].componentSubType = JucePlugin_AUSubType;
        inDescArray[0].componentManufacturer = JucePlugin_AUManufacturerCode;
        inDescArray[0].componentFlags = 0;
    ...
    void audioProcessorParameterChanged (AudioProcessor*, int index, float /*newValue*/) override
    {
        DBG("*** JuceAU audioProcessorParameterChanged");
        if (inParameterChangedCallback.get())
        {
            inParameterChangedCallback = false;
            return;
    ...
    void audioProcessorParameterChangeGestureBegin (AudioProcessor*, int index) override
    {
        DBG("*** JuceAU audioProcessorParameterChangeGestureBegin");
        sendAUEvent (kAudioUnitEvent_BeginParameterChangeGesture, index);
    }

    void audioProcessorParameterChangeGestureEnd (AudioProcessor*, int index) override
    {
        DBG("*** JuceAU audioProcessorParameterChangeGestureEnd");
        sendAUEvent (kAudioUnitEvent_EndParameterChangeGesture, index);
    }

    void audioProcessorChanged (AudioProcessor*) override
    {
        DBG("*** JuceAU audioProcessorChanged");
    ...
    void parameterValueChanged (int, float) override
    {
        DBG("*** JuceAU parameterValueChanged");

        PropertyChanged (kAudioUnitProperty_BypassEffect, kAudioUnitScope_Global, 0);
    }

    void parameterGestureChanged (int, bool) override {DBG("*** JuceAU parameterGestureChanged");}

    //==============================================================================
    bool StreamFormatWritable (AudioUnitScope scope, AudioUnitElement element) override
    {
      DBG("*** JuceAU StreamFormatWritable");
        bool ignore;
        int busIdx;
    ...
    //==============================================================================
    ComponentResult StartNote (MusicDeviceInstrumentID, MusicDeviceGroupID, NoteInstanceID*, UInt32, const MusicDeviceNoteParams&) override { DBG("*** JuceAU StartNote");return noErr; }
    ComponentResult StopNote (MusicDeviceGroupID, NoteInstanceID, UInt32) override   { DBG("*** JuceAU StopNote");return noErr; }

    //==============================================================================
    OSStatus HandleMidiEvent (UInt8 nStatus, UInt8 inChannel, UInt8 inData1, UInt8 inData2, UInt32 inStartFrame) override
    {
      DBG("*** JuceAU HandleMidiEvent");
    ...
    OSStatus NewFactoryPresetSet (const AUPreset& inNewFactoryPreset) override
    {
      DBG("*** JuceAU NewFactoryPresetSet");
    ...
    public:
        EditorCompHolder (AudioProcessorEditor* const editor)
        {
          DBG("*** EditorCompHolder constructor");
        ...
        ~EditorCompHolder() override
        {
          DBG("*** EditorCompHolder destructor");
        ...
        Rectangle<int> getSizeToContainChild()
        {
          DBG("*** EditorCompHolder getSizeToContainChild");
        ...
        static NSView* createViewFor (AudioProcessor* filter, JuceAU* au, AudioProcessorEditor* const editor)
        {
          DBG("*** EditorCompHolder createViewFor");
        ...
        void parentSizeChanged() override
        {
          DBG("*** EditorCompHolder parentSizeChanged");
        ...
        void childBoundsChanged (Component*) override
        {
          DBG("*** EditorCompHolder childBoundsChanged");
        ...
        bool keyPressed (const KeyPress&) override
        {
          DBG("*** EditorCompHolder keyPressed");
        ...
        void resizeHostWindow()
        {
          DBG("*** EditorCompHolder resizeHostWindow");
    ...
    void deleteActiveEditors()
    {
      DBG("*** EditorCompHolder deleteActiveEditors");
    ...
    struct JuceUIViewClass  : public ObjCClass<NSView>
    {
        JuceUIViewClass()  : ObjCClass<NSView> ("JUCEAUView_")
        {
          DBG("*** JuceUIViewClass constructor");
        ...
        static void deleteEditor (id self)
        {
          DBG("*** JuceUIViewClass deleteEditor");
        ...
        static JuceAU* getAU (id self)                          { DBG("*** JuceUIViewClass getAU"); return getIvar<JuceAU*> (self, "au"); }
        static EditorCompHolder* getEditor (id self)            { DBG("*** JuceUIViewClass getEditor"); return getIvar<EditorCompHolder*> (self, "editor"); }

        static void setFilter (id self, AudioProcessor* filter) { DBG("*** JuceUIViewClass setFilter"); object_setInstanceVariable (self, "filter", filter); }
        static void setAU (id self, JuceAU* au)                 { DBG("*** JuceUIViewClass setAU"); object_setInstanceVariable (self, "au", au); }
        static void setEditor (id self, EditorCompHolder* e)    { DBG("*** JuceUIViewClass setEditor"); object_setInstanceVariable (self, "editor", e); }

    private:
        static void dealloc (id self, SEL)
        {
          DBG("*** JuceUIViewClass dealloc");
        ...
        static void applicationWillTerminate (id self, SEL, NSNotification*)
        {
          DBG("*** JuceUIViewClass applicationWillTerminate");
        ...
        static void viewDidMoveToWindow (id self, SEL)
        {
          DBG("*** JuceUIViewClass viewDidMoveToWindow");
        ...
        static BOOL mouseDownCanMoveWindow (id, SEL)
        {
          DBG("*** JuceUIViewClass mouseDownCanMoveWindow");
    ...
    struct JuceUICreationClass  : public ObjCClass<NSObject>
    {
        JuceUICreationClass()  : ObjCClass<NSObject> ("JUCE_AUCocoaViewClass_")
        {
          DBG("*** JuceUICreationClass constructor");
    ...
    private:
        static unsigned int interfaceVersion (id, SEL)   { DBG("*** JuceUICreationClass interfaceVersion"); return 0; }

        static NSString* description (id, SEL)
        {
            DBG("*** JuceUICreationClass description");
            return [NSString stringWithString: nsStringLiteral (JucePlugin_Name)];
        }

        static NSView* uiViewForAudioUnit (id, SEL, AudioUnit inAudioUnit, NSSize)
        {
          DBG("*** JuceUICreationClass uiViewForAudioUnit");
...
private:
    ...
    static NSRect convertToHostBounds (NSRect pluginRect)
    {
      DBG("*** JUCEAU convertToHostBounds");
    ...
    static NSRect convertFromHostBounds (NSRect hostRect)
    {
      DBG("*** JUCEAU convertFromHostBounds");
    ...
    void prepareOutputBuffers (const UInt32 nFrames) noexcept
    {
      DBG("*** JUCEAU prepareOutputBuffers");
    ...
    AudioUnitParameterID generateAUParameterID (AudioProcessorParameter* param) const
    {
      DBG("*** JUCEAU generateAUParameterID");
    ...
    inline AudioUnitParameterID getAUParameterIDForIndex (int paramIndex) const noexcept
    {
      DBG("*** JUCEAU getAUParameterIDForIndex");
    ...
    AudioProcessorParameter* getParameterForAUParameterID (AudioUnitParameterID address) const noexcept
    {
      DBG("*** JUCEAU getParameterForAUParameterID");
    ...
    OSStatus syncAudioUnitWithProcessor()
    {
      DBG("*** JUCEAU syncAudioUnitWithProcessor");
    ...
    OSStatus syncProcessorWithAudioUnit()
    {
      DBG("*** JUCEAU syncProcessorWithAudioUnit");
    ...
    OSStatus syncAudioUnitWithChannelSet (bool isInput, int busNr, const AudioChannelSet& channelSet)
    {
      DBG("*** JUCEAU syncAudioUnitWithChannelSet");
    ...
    void refreshCurrentPreset()
    {
      DBG("*** JUCEAU refreshCurrentPreset");
    ...
    //==============================================================================
  Array<AudioChannelLayoutTag>&       getSupportedBusLayouts (bool isInput, int bus) noexcept       { DBG("*** JUCEAU getSupportedBusLayouts"); return (isInput ? supportedInputLayouts : supportedOutputLayouts).getReference (bus); }
    const Array<AudioChannelLayoutTag>& getSupportedBusLayouts (bool isInput, int bus) const noexcept { DBG("*** JUCEAU getSupportedBusLayouts");return (isInput ? supportedInputLayouts : supportedOutputLayouts).getReference (bus); }
    AudioChannelLayoutTag& getCurrentLayout (bool isInput, int bus) noexcept               { DBG("*** JUCEAU getCurrentLayout");return (isInput ? currentInputLayout : currentOutputLayout).getReference (bus); }
    AudioChannelLayoutTag  getCurrentLayout (bool isInput, int bus) const noexcept         { DBG("*** JUCEAU getCurrentLayout");return (isInput ? currentInputLayout : currentOutputLayout)[bus]; }

    //==============================================================================
    void addSupportedLayoutTagsForBus (bool isInput, int busNum, Array<AudioChannelLayoutTag>& tags)
    {
      DBG("*** JUCEAU addSupportedLayoutTagsForBus");
        if (AudioProcessor::Bus* bus = juceFilter->getBus (isInput, busNum))
        {
           #ifndef JucePlugin_PreferredChannelConfigurations
            auto& knownTags = CoreAudioLayouts::getKnownCoreAudioTags();
    ...
    void addSupportedLayoutTagsForDirection (bool isInput)
    {
      DBG("*** JUCEAU addSupportedLayoutTagsForDirection");
    ...
    void addSupportedLayoutTags()
    {
      DBG("*** JUCEAU addSupportedLayoutTags");
    ...
    static int maxChannelsToProbeFor()
    {
      DBG("*** JUCEAU maxChannelsToProbeFor");
    ...
    static void auPropertyListenerDispatcher (void* inRefCon, AudioUnit, AudioUnitPropertyID propId,
                                              AudioUnitScope scope, AudioUnitElement element)
    {
      DBG("*** JUCEAU auPropertyListenerDispatcher");
...
public:
    JuceAUView (AudioUnitCarbonView auview)
      : AUCarbonViewBase (auview),
        juceFilter (nullptr)
    {
      DBG("*** JuceAuView constructor");

    }

    ~JuceAUView()
    {
      DBG("*** JuceAuView destructor");
    ...
    AudioUnitCarbonViewEventListener getEventListener() const   { DBG("*** JuceAuView getEventListener");return mEventListener; }
    void* getEventListenerUserData() const                      { DBG("*** JuceAuView getEventListenerUserData");return mEventListenerUserData; }
    ...
    public:
        ComponentInHIView (AudioProcessorEditor* ed, HIViewRef parentHIView)
            : parentView (parentHIView),
              ...
              recursive (false)
        {
          DBG("*** ComponentInHIView constructor");
        ...
        ~ComponentInHIView()
        {
          DBG("*** ComponentInHIView destructor");
        ...
        void updateWindowPos()
        {
          DBG("*** ComponentInHIView updateWindowPos");
        ...
        void addSubWindow()
        {
          DBG("*** ComponentInHIView addSubWindow");
        ...
        void childBoundsChanged (Component*) override
        {
          DBG("*** ComponentInHIView childBoundsChanged");
            if (! recursive)
            {
                recursive = true;
        ...
        bool keyPressed (const KeyPress& kp) override
        {
          DBG("*** ComponentInHIView keyPressed");
